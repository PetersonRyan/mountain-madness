...
function addCard(content){
    ...
    var cardTemplate = "<div class='col m6 s12'>\n" +
        ...
        "                                    <p class='condition'>" + laymans[content.dailyForecast[0].icon.replace(/-/g, "_")] + " " + content.dailyForecast[0].temperature + "&deg;C</p>\n" +
        "                                    <p class='weather-date'>Feb 24</p>\n" +
        "                                </div>\n" +
        "                                <div class='col s2'>\n" +
        "                                    <i class='wi " + icons[content.dailyForecast[1].icon.replace(/-/g, "_")] + "'></i>\n" +
        "                                    <p class='condition'>" + laymans[content.dailyForecast[1].icon.replace(/-/g, "_")] + " " + content.dailyForecast[1].temperature + "&deg;C</p>\n" +
        "                                    <p class='weather-date'>Feb 24</p>\n" +
        "                                </div>\n" +
        "                                <div class='col s2'>\n" +
        "                                    <i class='wi " + icons[content.dailyForecast[2].icon.replace(/-/g, "_")] + "'></i>\n" +
        "                                    <p class='condition'>" + laymans[content.dailyForecast[2].icon.replace(/-/g, "_")] + " " + content.dailyForecast[2].temperature + "&deg;C</p>\n" +
        "                                    <p class='weather-date'>Feb 24</p>\n" +
        "                                </div>\n" +
        "                                <div class='col s2'>\n" +
        "                                    <i class='wi " + icons[content.dailyForecast[3].icon.replace(/-/g, "_")] + "'></i>\n" +
        "                                    <p class='condition'>" + laymans[content.dailyForecast[3].icon.replace(/-/g, "_")] + " " + content.dailyForecast[3].temperature + "&deg;C</p>\n" +
        "                                    <p class='weather-date'>Feb 24</p>\n" +
        "                                </div>\n" +
        "                                <div class='col s2'>\n" +
        "                                    <i class='wi " + icons[content.dailyForecast[4].icon.replace(/-/g, "_")] + "'></i>\n" +
        "                                    <p class='condition'>" + laymans[content.dailyForecast[4].icon.replace(/-/g, "_")] + " " + content.dailyForecast[4].temperature + "&deg;C</p>\n" +
        "                                    <p class='weather-date'>Feb 24</p>\n" +
        "                                </div>\n" +
        "                                <div class='col s2'>\n" +
        "                                    <i class='wi " + icons[content.dailyForecast[5].icon.replace(/-/g, "_")]+ "'></i>\n" +
        "                                    <p class='condition'>" + laymans[content.dailyForecast[5].icon.replace(/-/g, "_")] + " " + content.dailyForecast[5].temperature + "&deg;C</p>\n" +
        "                                    <p class='weather-date'>Feb 24</p>\n" +
        "                                </div>\n" +
        "                            </div>\n" +
        "                        </div>\n" +
